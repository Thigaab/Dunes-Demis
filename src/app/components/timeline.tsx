...
const timelineItems: TimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "Préparation châssis et moteur. C'est l'ouverture des espaces publicitaires sur la carrosserie pour nos sponsors.",
    status: "future",
    icon: Wrench,
  },
  {
    ...
    description:
      "Centralisation des dons avec nos partenaires. Objectif : 50kg de matériel scolaire pour l'association Enfants du Désert.",
    status: "future",
    icon: Heart,
  },
  {
  ...
  },
  {
    ...
    description:
      "6 000 km d'impact solidaire à travers le désert. Suivi en direct et reportages quotidiens sur nos réseaux.",
    status: "future",
    icon: Map,
  },
];
...
function TimelineMarker({ status, Icon }: { status: TimelineStatus; Icon: LucideIcon }) {
  if (status === "passed") {
    return (
      <span
        className="inline-flex h-6 w-6 items-center justify-center rounded-full border-2 border-[#f58d47] bg-[#f58d47] text-white"
        aria-hidden="true"
      >
  ...
  if (status === "current") {
    return (
      <span
        className="tl-pulse relative inline-flex h-6 w-6 items-center justify-center rounded-full border-2 border-[#f58d47] bg-white text-[#f58d47] ring-4 ring-orange-200/50"
        aria-hidden="true"
      >
  ...
  return (
    <span
      className="inline-flex h-6 w-6 items-center justify-center rounded-full border-2 border-[#c8b8a3] bg-white text-[#a7927a]"
      aria-hidden="true"
    >
        ...
        <ol className="tl-list relative space-y-6 border-l-2 border-[#d8c9b6]/40 pl-8">
          {timelineItems.map((item, i) => (
            ...
            >
              ...
              <div className="tl-card adventure-card rounded-2xl border border-[#decbb4] p-5">
                <p className="tl-date text-sm font-bold tracking-wide text-[#e47e3a]">
                  {item.date}
                </p>
